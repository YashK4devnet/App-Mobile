...
export const SYSTEM_DETAILS_SCHEMA = [
  ...
  { name: 'total_systems_available', label: 'Total Number of Systems Available', type: 'number', placeholder: 'e.g. 200' },
  { name: 'machine_look_and_feel', label: 'Look & Feel and Maintenance of Machines', type: 'quality' },

  { type: 'heading', label: 'Node Counts (Available vs Working)' },
  { name: 'test_nodes', label: 'Test Nodes', type: 'node-counts' },
  { name: 'buffer_nodes', label: 'Buffer Nodes', type: 'node-counts' },
  { name: 'registration_desk_nodes', label: 'Registration Desk Nodes', type: 'node-counts' },
  { name: 'aadhaar_desk_nodes', label: 'Aadhar Desk Nodes', type: 'node-counts' },
  { name: 'video_recording_machines', label: 'Video Recording Machine', type: 'node-counts' },

  { type: 'heading', label: 'Types of Processors' },
  { name: 'processor_i3_available', label: 'Number of available INTEL Core i3 processors', type: 'number' },
  { name: 'processor_i3_working', label: 'Number of working INTEL Core i3 processors', type: 'number' },
  { name: 'processor_i3_available_speed', label: 'Speed of the INTEL Core i3 processors', type: 'text' },
  { name: 'processor_i5_available', label: 'Number of available INTEL Core i5 processors', type: 'number' },
  { name: 'processor_i5_working', label: 'Number of working INTEL Core i5 processors', type: 'number' },
  { name: 'processor_i5_available_speed', label: 'Speed of the INTEL Core i5 processors', type: 'text' },
  { name: 'processor_i7_available', label: 'Number of available INTEL Core i7 processors', type: 'number' },
  { name: 'processor_i7_working', label: 'Number of working INTEL Core i7 processors', type: 'number' },
  { name: 'processor_i7_available_speed', label: 'Speed of the INTEL Core i7 processors', type: 'text' },
  { type: 'heading', label: 'Types of OS' },
  { name: 'win7_available', label: 'Number of available win7 pcs', type: 'number' },
  { name: 'win7_working', label: 'Number of working win7 pcs', type: 'number' },
  { name: 'win8_available', label: 'Number of available win8 pcs', type: 'number' },
  { name: 'win8_working', label: 'Number of working win8 pcs', type: 'number' },
  { name: 'win10_available', label: 'Number of available win10 pcs', type: 'number' },
  { name: 'win10_working', label: 'Number of working win10 pcs', type: 'number' },
  { name: 'win11_available', label: 'Number of available win11 pcs', type: 'number' },
  { name: 'win11_working', label: 'Number of working win11 pcs', type: 'number' },
  { name: 'linux_available', label: 'Number of available linux pcs', type: 'number' },
  { name: 'linux_working', label: 'Number of working linux pcs', type: 'number' },
  { name: 'other_os_available', label: 'Number of available other os pcs', type: 'number' },
  { name: 'other_os_working', label: 'Number of working other os pcs', type: 'number' },
  { name: 'ie_version', label: 'Internet explorer version available', type: 'select', options: ['ie8', 'ie9', 'ie10'] },
  { type: 'heading', label: 'Types of RAM' },
  { name: 'ram_2gb_available', label: 'Number of available 2GB ram', type: 'number' },
  { name: 'ram_2gb_working', label: 'Number of working 2GB ram', type: 'number' },
  { name: 'ram_4gb_available', label: 'Number of available 4GB ram', type: 'number' },
  { name: 'ram_4gb_working', label: 'Number of working 4GB ram', type: 'number' },
  { name: 'ram_8gb_available', label: 'Number of available 8GB ram', type: 'number' },
  { name: 'ram_8gb_working', label: 'Number of working 8GB ram', type: 'number' },
  { type: 'heading', label: 'Types of HDD' },
  { name: 'hdd_256gb_available', label: 'Number of available 256GB HDD', type: 'number' },
  { name: 'hdd_256gb_working', label: 'Number of working 256GB HDD', type: 'number' },
  { name: 'hdd_512gb_available', label: 'Number of available 512GB HDD', type: 'number' },
  { name: 'hdd_512gb_working', label: 'Number of working 512GB HDD', type: 'number' },
  { name: 'hdd_1tb_available', label: 'Number of available 1TB HDD', type: 'number' },
  { name: 'hdd_1tb_working', label: 'Number of working 1TB HDD', type: 'number' },
  { type: 'heading', label: 'Types of Monitor' },
  { name: 'monitor_15_available', label: 'Number of available 15 inch monitors', type: 'number' },
  { name: 'monitor_15_working', label: 'Number of working 15 inch monitors', type: 'number' },
  { name: 'monitor_17_available', label: 'Number of available 17 inch monitors', type: 'number' },
  { name: 'monitor_17_working', label: 'Number of working 17 inch monitors', type: 'number' },
  { name: 'monitor_19_available', label: 'Number of available 19 inch monitors', type: 'number' },
  { name: 'monitor_19_working', label: 'Number of working 19 inch monitors', type: 'number' },

  { type: 'heading', label: 'Policies & Software' },
  { name: 'os_license_available', label: 'OS License Available on All Client Nodes?', type: 'yes-no' },
  { name: 'system_format_allowed', label: 'Centre Will Allow to Format the System if Needed?', type: 'yes-no' },
  { name: 'antivirus_available', label: 'Antivirus Available at the Center?', type: 'yes-no' },
  {
    type: 'group',
    className: 'bg-white/5 p-3 rounded-xl border border-white/10 space-y-4 animate-fade-in',
    showIf: (data) => data.antivirus_available === 'yes',
    fields: [
      { name: 'antivirus_name', label: 'Name of Antivirus Installed on PC', type: 'text', placeholder: 'e.g. Windows Defender' },
      { name: 'disable_antivirus_permitted', label: 'Disabling Antivirus Permitted?', type: 'yes-no' }
    ]
  },
  { name: 'remote_software_found', label: 'Remote Software Status', type: 'text', placeholder: 'e.g. AnyDesk installed, TeamViewer disabled' },

  { type: 'heading', label: 'Feedback' },
  { name: 'overall_system_feedback', label: 'Overall System Feedback', type: 'textarea', placeholder: 'Enter remarks...' }
];
