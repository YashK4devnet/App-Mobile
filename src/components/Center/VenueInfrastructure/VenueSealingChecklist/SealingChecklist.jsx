...
import styles from "./SealingChecklist.module.css";
import ChecklistForm from "./components/ChecklistForm";
import { getSealingChecklist } from "./api/getSealingChecklist";

const LOCAL_KEY = "SealingChecklistData";

const SealingChecklist = () => {
  ...
  const fetchChecklists = async () => {
    ...
    setError("");
    try {
      const response = await getSealingChecklist(userLoginData);
      if (response?.Status) {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.header}>
        <h1 className={styles.title}>Sealing Checklist</h1>
        {!showFetchBtn && (
...
export default SealingChecklist;
